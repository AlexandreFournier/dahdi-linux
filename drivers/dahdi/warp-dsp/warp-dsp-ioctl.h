...
#define DSP_PEEK_ADDRESS32		_IO(DSP_IOC_MAGIC, 13)
#define DSP_POKE_ADDRESS32		_IO(DSP_IOC_MAGIC, 14)
#define DSP_GET_IRQCOUNT		_IO(DSP_IOC_MAGIC, 15)
#define DSP_CLEAR_IRQCOUNT		_IO(DSP_IOC_MAGIC, 16)
#define DSP_GET_DSPCOUNT		_IO(DSP_IOC_MAGIC, 17)
