...
void warp_dsp_delay(unsigned int dsp_id, unsigned int delay_type);
...
int dahdi_warp_get_num_g729_channels(unsigned short dsp_id);
...
#define DSP_LICENSE_LOG		0x00000100
#define DSP_IRQ_LOG			0x00000200
#define DSP_LOCK_LOG		0x00000400
#define DSP_HPORT_LOG		0x00000800
