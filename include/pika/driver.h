...
#define BAR0_FPGA_UPDATE         0x0004 /* FPGA Update */
 ...
 * driver.
 */
#define IMR_FPGA_MASK 0xc0000fff

#if defined( _M_MPPC  ) || defined( _M_PPC ) || defined(PPC) || defined(__PPC) || defined(_ARCH_PPC)
# define BAR0_READ(pdx, reg)              in_be32((unsigned __iomem *)(pdx->bar0 + reg))
# define BAR0_WRITE(pdx, reg, value)      out_be32((unsigned __iomem *)(pdx->bar0 + reg), value)
# define BAR0_READ_BYTE(pdx, reg)         in_be16((unsigned __iomem *)(pdx->bar0 + reg))
# define BAR0_WRITE_BYTE(pdx, reg, value) out_be32((unsigned __iomem *)(pdx->bar0 + reg), value)
#else
...
# define BAR0_WRITE_BYTE(pdx, reg, value) writeb(value, pdx->bar0 + reg)
#endif
...
int daytona_set_threshold(PDEVICE_EXTENSION pdx, u32 trunk, u32 threshold);
...
int daytona_phone_get_diag(PDEVICE_EXTENSION pdx, int phone, phone_get_diag_out_t *usrBuf);
...
#define BCAST 0x80
static inline void WriteSilabsIndirect(PDEVICE_EXTENSION pdx, u8 channel, u8 ind_reg_offset , u16 data)
{
